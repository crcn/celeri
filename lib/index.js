...
exports.inputChar = function(char)
{
    if(!arguments.length) return _inputChar;
    
    
    return _inputChar = char || '';
}
...
exports.open = function(ops)
{
    if(ops)
    {
        if(ops.inputChar) exports.inputChar(ops.inputChar);
    }
    ...
    stdin.on('keypress', function(c, key)
    {
        ...
        if(!emitSuccess && c)
        {
            if(!_buffer.length)
            {
                exports.insertText(exports.inputChar(), _cursorPosition);
            }
