...
exports.plugin = function(cli) {
    ...
    cli.addHelp = function(ops) {
        ...
        for(var category in ops.options) {
            
            var childOp = ops.options[category];

            for(var name in childOp) {

                childHelp.add(category, name, childOp[name])
